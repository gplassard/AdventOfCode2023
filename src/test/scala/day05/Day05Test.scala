...
class Day05Test extends AnyWordSpec with Matchers {
  ...
  "part1" should {
    ...
    "work for the sample" in {
      val measures = Files
        .lines(Paths.get("src/test/resources/day05/sample.txt"))
        .toScala(List)
    ...
    "work for the input" in {
      val measures = Files
        .lines(Paths.get("src/test/resources/day05/input.txt"))
        .toScala(List)
  ...
  "Range" should {
    "not intersect with a transformer (lower)" in {
      ...
      val (intersected, lower, higher) =
        Day05.Range(0, 10).transform(Day05.Transformer(200, 100, 10))
    ...
    "not intersect with a transformer (higher)" in {
      ...
      // result             .....................................300...310
      val (intersected, lower, higher) =
        Day05.Range(300, 310).transform(Day05.Transformer(200, 100, 10))
    ...
    "intersect in lower" in {
      ...
      val (intersected, lower, higher) =
        Day05.Range(95, 105).transform(Day05.Transformer(200, 100, 10))
    ...
    "intersect in higher" in {
      ...
      val (intersected, lower, higher) =
        Day05.Range(105, 115).transform(Day05.Transformer(200, 100, 10))
    ...
    "overlapping source" in {
      ...
      val (intersected, lower, higher) =
        Day05.Range(95, 115).transform(Day05.Transformer(200, 100, 10))
    ...
    "overlapping transformer" in {
      ...
      // result             ........................................200..210
      val (intersected, lower, higher) =
        Day05.Range(100, 110).transform(Day05.Transformer(195, 95, 20))
