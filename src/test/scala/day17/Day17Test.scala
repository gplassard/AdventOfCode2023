...
class Day17Test extends AnyWordSpec with Matchers {
  ...
  "part1" should {
    ...
    "work for the sample-2" in {
      val measures = Files.lines(Paths.get("src/test/resources/day17/sample-2.txt")).toScala(List)
      Day17.part1(measures) should equal(59)
    }

    "work for the sample-3" in {
      val measures = Files.lines(Paths.get("src/test/resources/day17/sample-3.txt")).toScala(List)
      Day17.part1(measures) should equal(17)
    }
    "work for the sample-4" in {
      val measures = Files.lines(Paths.get("src/test/resources/day17/sample-4.txt")).toScala(List)
