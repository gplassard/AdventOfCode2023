...
class Day20Test extends AnyWordSpec with Matchers {
  ...
  "part1" should {
    ...
    "work for the sample" in {
      val measures = Files
        .lines(Paths.get("src/test/resources/day20/sample.txt"))
        .toScala(List)
    ...
    "work for the sample-2" in {
      val measures = Files
        .lines(Paths.get("src/test/resources/day20/sample-2.txt"))
        .toScala(List)
    ...
    "work for the input" in {
      val measures = Files
        .lines(Paths.get("src/test/resources/day20/input.txt"))
        .toScala(List)
  ...
  "part2" should {
    "work for the input" in {
      val measures = Files
        .lines(Paths.get("src/test/resources/day20/input.txt"))
        .toScala(List)
      Day20.part2(measures) should equal(228060006554227L)
    }
  }
}
